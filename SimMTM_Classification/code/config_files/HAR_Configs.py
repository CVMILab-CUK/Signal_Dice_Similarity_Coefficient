"""HAR dataset configuration for AAAI27 Classification Confirmatory.

HAR: 9 channels (body + total accelerometer + gyroscope, x/y/z each), T=128,
6 activity classes (walking, walking_upstairs, walking_downstairs, sitting,
standing, laying). Source: TF-C benchmark (Zhang et al., NeurIPS 2022).
"""
